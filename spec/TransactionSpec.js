describe("Transaction", function() {
  ...
  it("logs deposit transaction info date/deposit/credit/balance", function() {
    ...
    expect(deposit3.logTransaction(500, 500).credit).toEqual(500);
    expect(deposit3.logTransaction(500, 500).date).toEqual("13/03/2019");
    expect(deposit3.logTransaction(500, 500).balance).toEqual(500);
    // "{date: 13/03/2019, credit: 500, balance: 500}"
  });
  it("logs withdrawal transaction info date/deposit/credit/balance", function() {
    spyOn(Date, "now").and.returnValue(1552435200000);
    withdrawal1 = new Transaction(100);
    expect(withdrawal1.logTransaction(-100, 100).debit).toEqual(100);
    expect(withdrawal1.logTransaction(-100, 100).date).toEqual("13/03/2019");
    expect(withdrawal1.logTransaction(-100, 100).balance).toEqual(100);
  });
});
